...
msg="Session-start protocol is in effect (framework/CLAUDE.md §0). Run /session-start now: post the context manifest BEFORE changing code. Edit/Write/Bash stay blocked until /session-start acknowledges this session."
