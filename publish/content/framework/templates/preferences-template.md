...
#
# See: <WORKSPACE_REPO>/framework/policies/framework-policy.md (POL-131 to POL-136)
...
# Note: model/provider must still be on the approved list in ../../org-config.yaml
...
- Anything that contradicts <WORKSPACE_REPO>/framework/policies/
