...
- [Setting up your machine](../use-cases/setting-up-your-machine.md)

## 2. Understand what you are about to commit the organization to

- [Concepts](../specs/concepts.md) — workspace, project, knowledge layers, compliance levels
- [Organization AI agent governance policy](../policies/org-ai-agent-governance-policy.md) —
...
- [Organization AI agent governance policy §3](../policies/org-ai-agent-governance-policy.md)

## 4. Decide which agents your organization allows

- [LLM governance](../policies/llm-governance.md) — the approved list is a file, not a memory
- [Configuring agent harnesses](../use-cases/configuring-agent-harnesses.md) — what each agent
