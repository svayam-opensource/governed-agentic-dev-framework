#!/usr/bin/env bats
# P3 coverage — `prj finish`: dispatches and offers its first choice; choosing
...
@test "finish: dispatches and steps back cleanly" {
  run bash -c "printf '%b' '0\n' | ADF_WORKSPACE='$ADF_WORKSPACE' bash '$PRJ_BIN' finish"
  assert_success
