...
import { deriveOrgConfig, renderOrgConfig } from "./setup.js";
export async function runSetup(io, interactive) {
    const ctx = { originUrl: io.originUrl, ghUser: io.ghUser, gitEmail: io.gitEmail, today: io.today, existing: io.existing };
    const answers = {};
    if (interactive) {
