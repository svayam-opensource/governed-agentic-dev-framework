...
- **Currency:** Must reflect current `master` within 1 hour of any merge
...
- All `projects/SVM-NNN-slug/knowledge/` content
...
- **Update strategy:** Re-embed only changed files on each master merge (not full re-index)
...
1. Pull project knowledge from `projects/SVM-NNN-slug/`
...
- [ ] All three forms regenerate automatically on master merge via CI/CD
