...
RC="$SC/home/.zshrc"
# HOME isolated to the scratch; SETUP_FORCE_SHELL_RC=1 forces the rc write (stdin isn't a TTY
# under the test runner) so we can verify it WITHOUT touching the real ~/.zshrc.
do_setup() { HOME="$SC/home" SHELL=/bin/zsh SETUP_FORCE_SHELL_RC=1 \
