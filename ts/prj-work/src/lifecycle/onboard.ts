...
export type OnboardResult =
  ...
  | { readonly ok: false; readonly code: number; readonly reason: "knowledge-exists" | "branch-exists"; readonly message: string };

function agentMd(input: OnboardInput, config: OnboardConfig): string {
...
function repoDoc(owner: string, todo: string): string {
  return `**Owner:** ${owner}
...
function prBody(repoName: string, orgName: string): string {
...
export function onboard(deps: OnboardDeps, config: OnboardConfig, input: OnboardInput): OnboardResult {
